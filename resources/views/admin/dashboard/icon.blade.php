...
@section('breadcrumb') Icon @endsection
@section('css')
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Mod</h4>
                    <div class="icon-list-demo row">
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="ti-bus"> </i> ti-bus </div>
                        <div class="col-sm-6 col-md-4 col-lg-3"> <i class="ti-meal"> </i> ti-meal </div>
