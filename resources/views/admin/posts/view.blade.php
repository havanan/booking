    ...
    <div class="form-material m-t-10">
        <div class="row">
            <div class="col-md-8 text-left pb-2">
                <a href="{{route('admin.post.index')}}" class="btn btn-secondary"><i class="icon-arrow-left-circle"></i></a>
                <a href="{{route('admin.post.create')}}" class="btn btn-info"><i class="icon-plus"></i></a>
                @if(Auth::user()->id == $info['author_id'] || Auth::user()->role == 1)
                    <a href="{{route('admin.post.edit',$info['id'])}}" class="btn btn-primary"><i class="icon-pencil"></i></a>
